...
import com.commonrpg.util.IoUtils;
...
public class RpcClient
{
    ...
    private PHPRPC_Client getClient(String server, String remoteClass)
    {
        ...
        if (client == null)
        {
            ...
            client.setPrivateKey(AppConfig.PHPRPC_PRIVATE_KEY);
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(rc.callDirect("localhost:8181", "hotswaper", "redefineClass", new Object[]{IoUtils.read("src/com/commonrpg/remote/phprpc/Status.java")}));
