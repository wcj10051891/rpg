package com.commonrpg.remote.servlet;
...
import com.commonrpg.util.LockFreeDeque;
...
public class PhpRpcDispatcher extends GenericServlet
{
    ...
    {
    	for(Class<?> clazz : ClassUtils.scanPackage(AppConfig.PHPRPC_BEAN_PACKAGE)) {
            try
            {
    ...
    private class RpcServerPool
    {
        ...
        PHPRPC_Server getServer() throws InstantiationException, IllegalAccessException
        {
            ...
            if (server == null)
            {
                ...
                server.setPrivateKey(AppConfig.PHPRPC_PRIVATE_KEY);
