...
public class JsonConfig {
   private static volatile JsonConfig DEFAULT_INSTANCE;
   ...
   private MultiKeyMap beanKeyMap = MultiKeyMap.decorate(new HashedMap(1));
   private Map beanProcessorMap = new HashMap(0);
   private MultiKeyMap beanTypeMap =  MultiKeyMap.decorate(new HashedMap(1));
   ...
   private Map defaultValueMap = new HashMap(0);
   ...
   private Map exclusionMap = new HashMap(0);
   ...
   private Map jsonPropertyNameProcessorMap = new HashMap(0);
   ...
   private Map keyMap = new HashMap(0);
   ...
   private Map typeMap = new HashMap(0);
   private List ignoreFieldAnnotations = new ArrayList(0);
   private boolean allowNonStringKeys = false;

   public JsonConfig() {
   }
   
   public static JsonConfig defaultInstance() {
	   if(DEFAULT_INSTANCE == null) {
		   DEFAULT_INSTANCE = new JsonConfig();
	   }
