...
public final class JSONArray extends AbstractJSON implements JSON, List, Comparable {
   ...
   public static JSONArray fromObject( Object object, JsonConfig jsonConfig ) {
      if( object instanceof JSONString ){
         ...
         return new JSONArray().element( object, jsonConfig );
         ...
         return new JSONArray().element( JSONObject.fromObject( object, jsonConfig ) );
      }else{
         throw new JSONException( "Unsupported type" );
      }
   }
   ...
   public static Object toArray( JSONArray jsonArray ) {
      return toArray( jsonArray, JsonConfig.defaultInstance() );
   }
   ...
   public static Collection toCollection( JSONArray jsonArray ) {
      return toCollection( jsonArray, JsonConfig.defaultInstance() );
   }
   ...
   public void add( int index, Object value ) {
      add( index, value, JsonConfig.defaultInstance() );
   }
   ...
   public boolean add( Object value ) {
      return add( value, JsonConfig.defaultInstance() );
   }
   ...
   public boolean addAll( Collection collection ) {
      return addAll( collection, JsonConfig.defaultInstance() );
   }
   ...
   public boolean addAll( int index, Collection collection ) {
      return addAll( index, collection, JsonConfig.defaultInstance() );
   }
   ...
   public boolean contains( Object o ) {
      return contains( o, JsonConfig.defaultInstance() );
   }
   ...
   public boolean containsAll( Collection collection ) {
      return containsAll( collection, JsonConfig.defaultInstance() );
   }
   ...
   public JSONArray element( Collection value ) {
      return element( value, JsonConfig.defaultInstance() );
   }
   ...
   public JSONArray element( int index, Collection value ) {
      return element( index, value, JsonConfig.defaultInstance() );
   }
   ...
   public boolean removeAll( Collection collection ) {
      return removeAll( collection, JsonConfig.defaultInstance() );
   }
   ...
   public boolean retainAll( Collection collection ) {
      return retainAll( collection, JsonConfig.defaultInstance() );
   }
   ...
   public Object set( int index, Object value ) {
      return set( index, value, JsonConfig.defaultInstance() );
   }
