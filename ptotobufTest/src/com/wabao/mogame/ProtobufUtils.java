...
public abstract class ProtobufUtils {
	...
	public static ResponseDto response(int sn, Object protobufObject) {
		...
		return ResponseDto.newBuilder().setSn(sn).setResult(protobuf(protobufObject)).build();
	}
	
	public static Object responseResult(ResponseDto response) throws Exception {
