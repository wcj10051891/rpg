package com.wabao.mogame.dynamic;

import java.lang.reflect.Field;
import java.lang.reflect.Method;
import java.lang.reflect.Modifier;

import com.wabao.mogame.dynamic.compiler.StringSourceCompiler;
import com.wabao.mogame.service.Services;

public abstract class Dynamic {
	public static boolean redifineClass(String sourceCode) throws Exception {
		Services.appService.instrument.redefineClasses(StringSourceCompiler.compile(sourceCode));
		return true;
	}
