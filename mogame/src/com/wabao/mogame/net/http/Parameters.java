...
public final class Parameters extends MultiMap {
    ...
    // add by kofboy@163.com
    public void setQuery( String query ) {
        this.queryMB = MessageBytes.newInstance();
        queryMB.setString(query);
    }
    ...
    */
    public void push() {
        ...
        // set child to null !
        if( urlDec==null )                   // add by kofboy@163.com
            urlDec=new UDecoder();
    ...
    // -------------------- Data access --------------------
    // Access to the current broadcastName/values, no side effect ( processing ).
    ...
    public Map<String, String[]> getParameterMap() {
        ...
        if( currentChild!=null ) {
            currentChild.merge();
            return currentChild.paramHashStringArray;
        }
        // merge in child
        return paramHashStringArray;
    }
    ...
    public void handleQueryParameters() {
        ...
        try {
            ...
            log.error("handleQueryParameters error.", e);
        }
    ...
    public void processParameters( byte bytes[], int start, int len,
        ...
        do {
            ...
            try {
                ...
                log.warn("Parameters: Fighter decoding failed. " +
                         "Parameter skipped.", e);
            }
    ...
    public void processParameters( char chars[], int start, int len ) {
        ...
        do {
            ...
            if( nameEnd<=nameStart ) {
                continue;
                // invalid chunk - no broadcastName, it's better to ignore
            }
            ...
            try {
                ...
                log.error("processParameters error.", ex);
            }
